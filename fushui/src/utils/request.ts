...
function get(path: string, params = {}, setting?: HttpRequestSetting): Promise<HttpResponseBodyType | undefined> {
...
function post(path: string, params = {}, setting?: HttpRequestSetting): Promise<HttpResponseBodyType | undefined> {
    const newSetting = {...defaultHttpRequestSetting, ...setting};
    // eslint-disable-next-line
...
async function getAsync(path: string, params = {}, setting?: HttpRequestSetting): Promise<[Error | null, HttpResponseBodyType | undefined]> {
    return await to<HttpResponseBodyType | undefined>(get(path, params, setting));
}

async function postAsync(path: string, params = {}, setting?: HttpRequestSetting): Promise<[Error | null, HttpResponseBodyType | undefined]> {
