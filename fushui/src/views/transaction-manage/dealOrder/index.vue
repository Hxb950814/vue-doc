    ...
    <div>
        ...
        <div class="page-cap-content" style="margin-top: 10px">
            <div class="hbb-page-top">
                <SearchView ref="SearchView"  mode="3" @submit="onSubmit"   @download="clickDownload"></SearchView>
            </div>
...
<script lang="ts">
    ...
    export default class extends Mixins(commonTable) {
        ...
        async getDataList() {
            ...
            const [err, resp] = await this.$postAsync('/userOrder/getChengOrderListPage', {
        ...
        clickDownload() {
            ...
            this.search = (this.$refs.SearchView as any).search
            const search = (this.search as any);
            this.$post('/userOrder/chengOrderListExcel', {
                orderNumber: search.orderNumber,
                endTime: search.endTime,
                startTime: search.startTime,
                code: search.code,
