    ...
    <div>
        <el-form :inline="true" :model="search" class="demo-form-inline">
            <el-form-item label="订单号：" :label-width="labelWidth">
                <el-input v-model="search.orderNumber" placeholder="请输入订单号"/>
            </el-form-item>
            ...
            <el-form-item label="操作方向：" :label-width="labelWidth">
                <el-select v-model="search.side" placeholder="请选择操作方向">
            ...
            <el-form-item label="订单来源：" :label-width="labelWidth">
                <el-select v-model="search.orderType" placeholder="请选择订单来源">
                    <el-option label="全部" value=""/>
                    <el-option label="手动下单" value="1"/>
                    <el-option label="云策略单" value="2"/>
                    <el-option label="云条件单" value="3"/>
                </el-select>
            </el-form-item>
            <el-form-item label="当前状态："  :label-width="labelWidth" v-if="mode === '2'" class="hbb">
                <el-select v-model="search.orderStatus" placeholder="请选择当前状态">
                    <el-option label="全部" value=""/>
                    <el-option label="未成" value="1"/>
                    <el-option label="部分成" value="2"/>
                    <el-option label="全成" value="3"/>
                    <el-option label="部分取消" value="4"/>
                    <el-option label="完全取消" value="5"/>
                    <el-option label="废单" value="6"/>
                </el-select>
            </el-form-item>
            <el-form-item  :label-width="labelWidth" :label="timeText + '：'" class="hbb">
                <el-date-picker
                    v-model="search.time"
                    type="daterange"
                    range-separator="至"
...
<script lang="ts">
    ...
    export default class extends Vue {
        ...
        search: any = {
            ...
            endTime: '', // 结束时间
            startTime: '', // 开始时间
            side: '', // 操作方向 全部、买多、卖空、买平、卖平
            orderType: '', // 订单来源 1手工 2 策略 3云单',
            mobile: '', // 订阅用户
            orderStatus: ''
        };
        ...
        mounted() {
            this.timeText = this.mode === '1'? '挂单时间': this.mode === '2'? '委托时间' : '成交时间';
        }
