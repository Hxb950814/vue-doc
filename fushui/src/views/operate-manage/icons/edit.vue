    ...
    <div>
        ...
        <div class="form-input-area">
            <el-form ref="dataForm" class="form-data form-style" :model="editData" :rules="dataRule">
                ...
                <el-form-item label="icon备注：" prop="description" label-width="120px">
                    <el-input
                ...
                <el-form-item label="icon位置：" prop="position" label-width="120px">
                ...
                <el-form-item label="icon类型：" prop="type" label-width="120px">
                    <el-select v-model.trim="editData.type" type="text" autocomplete="off" placeholder="请选择">
                        <el-option value="" label="全部" />
                        <el-option
                ...
                <el-form-item label="主页显示：" prop="isMain" label-width="120px">
                    <el-radio-group v-model="editData.isMain">
                        <el-radio label="1">
                            是
                        </el-radio>
                        <el-radio label="0">
    ...
    export default class extends Vue {
        ...
        async getData() {
            ...
            if (resp?.code === '000000') {
                ...
                this.editData.isMain = String(data.indexShow ? 1 : 0); // 是否主页显示
