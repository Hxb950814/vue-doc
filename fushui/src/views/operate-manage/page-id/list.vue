    ...
    <div>
        ...
        <div class="nav-common-search">
            <div class="search-line">
                ...
                <div class="search-union">
                    <span class="words">页面ID:</span>
                    <div class="input-text">
                        <el-input
                            v-model.trim="search.pageValue"
                            style="width: 160px"
                            type="text"
                            clearable
                            placeholder="请输入页面ID"
                ...
                <div class="search-union right">
                    <el-button v-permission="'03080101'" type="primary" @click="clickAddBanner">
        ...
        <div class="common-table" style="width: 100%;">
            <el-table :data="tableData.data">
                ...
                <el-table-column prop="operator" label="操作" width="100">
                    <template slot-scope="scope">
                        <a v-permission="'03080102'" class="link-btn color normal" style="margin: 0 5px" @click="clickEdit(scope.row.id)">查看</a>
                        <span v-if="checkPermissionNotExist('03080102')">--</span>
                    </template>
                </el-table-column>
            </el-table>
        ...
        mounted() {
         ...
         async getDataList() {
            ...
            const [err, resp] = await this.$postAsync('/icon/getpageList', {
                ...
                pageValue: this.search.pageValue
            }, {
                paramType: 'form'
            });
         ...
         clickAddBanner() {
            this.$router.push({
                path: '/operate_manage/page_id/add'
            });
        }

         clickEdit(id: string) {
            this.$router.push({
                path: '/operate_manage/page_id/edit',
                query: {
                    id
                }
            });
