    ...
    <div>
        <div class="form-input-area">
            ...
            <el-form ref="dataForm" class="form-data form-style" :model="editData" :rules="dataRule">
                ...
                <el-form-item v-viewer label="缩略图：" prop="thumbnail" label-width="120px">
                    <div class="dis-flex">
...
<script lang="ts">
    ...
    export default class extends Vue {
        ...
        dataRule: any = {
            ...
            label: [{required: true, message: '请文章标签', trigger: 'change'}],
        ...
        async getData() {
            ...
            if (resp?.code === '000000') {
                ...
                this.editData.title = data.title; // 标题
                this.editData.publishTime = data.publishTime; // 时间
                this.editData.tag = String(data.articleCategoryId); // 标签id
                this.editData.label = data.label ? String(data.label).split(',') : []; // 标签id
                this.editData.origin = data.articleFrom; // 位置
                this.editData.details = data.content; // 文章内容

                this.editData.thumbnail = data.imgName; // 图片
                this.editData.isTop = data.isTop ? '1' : '0'; // 是否置顶
