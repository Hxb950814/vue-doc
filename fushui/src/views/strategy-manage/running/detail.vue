        ...
        async getDetail() {
            ...
            if (resp?.code === '000000') {
                ...
                const {
                    ...
                    strategyPosition, strategyPositionList, strategyProfitChartConfigList, orderStatus, totalProfitMoney, tradeStatus, strategyCapital, totalProfitRate, tradeLevel
                } = resp?.data;
