        ...
        <div class="nav-common-search">
            <div class="search-line">
                ...
                <div class="search-union right">
                    ...
                    <el-button v-permission="'06030201'" type="primary" @click="clickAdd">
...
<script lang="ts">
    ...
    export default class extends Mixins(commonTable) {
        ...
        clickAdd(id: string) {
            this.$router.push({
                path: '/situation_manage/contract/stretch/add',
                query: {
                    id
                }
            });
        ...
        clickEdit(id: string) {
            this.$router.push({
                path: '/situation_manage/contract/stretch/detail',
                query: {
                    id
                }
            });
