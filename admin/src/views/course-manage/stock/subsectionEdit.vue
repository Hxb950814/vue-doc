...
<script lang="ts">
    ...
    export default class extends Vue {
        ...
        rules:any= {
            ...
            sectionImgUrl: [
                { required: true, message: '请输入小节介绍', trigger: 'blur' }
            ],
            display: [
        ...
        mounted() {
            ...
            this.chapterSectionId = String(this.$route.query.id);
        ...
        async getDetail() {
            this.$showLoading();
            const [err, resp] = await this.$postAsync('/course/queryNoListenCourseChapterSectionInfoById', {chapterSectionId: this.chapterSectionId});
            if (resp?.code === '000000') {
                const data = resp?.data;
                this.ruleForm.sectionTitle = data.sectionTitle;
                this.ruleForm.sectionNo = Number(data.sectionNo);
                this.ruleForm.author = data.author;
                this.ruleForm.sectionDescribe = data.sectionDescribe;
                this.ruleForm.courseTypeId = data.courseTypeId;
                this.ruleForm.courseChapterId = data.courseChapterId;
                this.ruleForm.courseFrom = String(data.courseFrom);
                this.ruleForm.isAudition = String(data.isAudition);
                this.ruleForm.contentUrl = data.contentUrl;
                this.ruleForm.contentSoundUrl = data.contentSoundUrl;
                this.ruleForm.sectionImgUrl = data.sectionImgUrl;
        ...
        async doSave() {
            ...
            const data: any = {
                ...
                chapterSectionId: this.chapterSectionId, // 小节id
