        ...
        <div class="account-section-content">
            <div>
                <div class="search-line">
                    <el-select v-model="search.status" placeholder="状态" style="width: 200px" clearable>
                        <el-option value="" label="全部" />
                        <el-option value="3" label="冻结" />
                        <el-option value="4" label="解冻返回" />
                        <el-option value="5" label="解冻支出" />
                        <el-option value="7" label="策略违约解冻返回" />
                        <el-option value="0" label="已结束" />
