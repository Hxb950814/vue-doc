...
<template>
    <div class="modify-form">
        <div>
            <el-input v-model.trim="name" type="text" placeholder="您的姓名"
                      maxlength="4" style="width: 250px"
            />
        </div>
        <div>
            <el-input v-model.trim="idcard" type="text" placeholder="您的身份证号" maxlength="18" style="width: 250px" />
        </div>
        <div>
...
<script lang="ts">
    ...
    export default class ModifyRealName extends Vue {
        name = '';
        idcard = '';
        ...
        async getData() {
            const [err, resp] = await postAsync('/systemInstall/queryRealNameInfo');
            if (resp?.code === '000000') {
