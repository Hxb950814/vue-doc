<template>
    <div style="float:left;width:100%">
        <div v-if="mode === '2'" class="hbb-bigNav">
        ...
        <div class="hbb-selectBox">
            <div class="right">
                <template v-if="mode === '1'">
                    <span v-if="strategyLabel1">{{ strategyLabel1 }}</span>
                    <span v-if="strategyLabel2">{{ strategyLabel2 }}</span>
                    <span v-if="strategyLabel3">{{ strategyLabel3 }}</span>
                </template>
            </div>
            <el-select v-model="timeType" style="width:120px" placeholder="请选择" @change="timeChange">
                <el-option
...
<script lang="ts">
    ...
    export default class extends Vue {
        @Prop({ type: String, default: '2', required: false })
        private mode?:string;

        strategyLabel1:string = ''; // 标签1
        strategyLabel2:string = ''; // 标签2
        strategyLabel3:string = ''; // 标签3
        ...
        active(res:any) {
            ...
            this.navList = arr;
            this.strategyLabel1 = (this.$parent as any).pageData.strategyLabel1;
            this.strategyLabel2 = (this.$parent as any).pageData.strategyLabel2;
            this.strategyLabel3 = (this.$parent as any).pageData.strategyLabel3;
            this.getDate();
        }
